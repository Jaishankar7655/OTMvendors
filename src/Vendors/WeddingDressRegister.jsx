...
const WeddingDressRegister = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("service_cat", "WeddingDresses"); // Adding the missing service_cat
...
export default WeddingDressRegister;
