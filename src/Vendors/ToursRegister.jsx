...
const ToursRegister = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("service_cat", "Tours And travel "); // Adding the missing service_cat
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 bg-gradient-to-r from-white to-red-50 p-8 rounded-xl shadow-lg relative overflow-hidden">
      ...
      <h2 className="text-center text-3xl font-bold mb-6 text-red-700 relative">
        Tours and Travel Services Registration
      ...
      >
        ...
        <div className="bg-white p-5 rounded-lg shadow-md mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              "Domestic ToursRegister",
              "International ToursRegister",
              "Adventure ToursRegister",
              "Pilgrimage ToursRegister",
              "Honeymoon Packages",
              "Wildlife ToursRegister",
              "Group ToursRegister",
              "Customized ToursRegister",
            ].map((spec) => (
              <label
                key={spec}
